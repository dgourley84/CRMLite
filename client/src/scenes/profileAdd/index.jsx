...
export default function  AddUser () {
  ...
  const [phoneNumber, setPhoneNumber] = useState({})
    ...
    async function handleSubmit(evt) {
      ...
      try {
        const values = {name, email, password,city, state,country,occupation,phoneNumber};
      ...
      <Box
        ...
        <Box component="main" noValidate sx={{mt:3}} gap="10">
          ...
          <FormControl sx={{mb: 2, mr:1}}>
            ...
            <Input id="password-input" aria-describedby="password-helper-text" onChange={e => setPassword(e.target.value)}/>
            <FormHelperText id="occupation-helper-text">Enter default password for customer</FormHelperText>
          </FormControl>
        </Box>
      </Box>
