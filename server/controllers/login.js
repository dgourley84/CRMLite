...
export async function updateUser(req,res){
    try {
        ...
        return res.status(401).send({ error: "Failing at this point" }); //when next is selected in the Auth file this is where the code stops. Which means the try isnt working above.
                                                                         //DG is of opinion that this is because the try doenst access the userId parameter properly. 
    }
}
