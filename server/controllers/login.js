...
/**GET http://localhost:5001/home/user this uses a webtoken to search the userId*/
...
export async function createCustomer(req, res) {
    try {
        const { email, password, name, city, state, country, occupation, phoneNumber } = req.body;
        ...
        await user.save();
        return res.status(201).send({ msg: "User Registeration Successful" });
    } catch (error) {
